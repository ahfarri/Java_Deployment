package com.farris.artists.services;
...
import com.farris.artists.repositories.UserRepository;
import com.farris.artists.repositories.WorkRepository;
...
//-----Ideas Services--------
    ...
    public List<Work> allWorksName(String work) {
        return workRepository.findByNameContaining(work);
    }
    ...
    public Work removeRelationship(Long ideaId, Long userId) {
    	Work thisWork = findWorkbyId(ideaId);
    	User thisUser = findUserById(userId);
